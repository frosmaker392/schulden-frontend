...
export type CreateExpenseMutation = {
  __typename?: 'Mutation'
  createExpense: { __typename?: 'Expense'; id: string; name: string }
}
...
export type DeleteExpenseMutation = {
  __typename?: 'Mutation'
  deleteExpense: { __typename?: 'Expense'; name: string }
}
...
export type GetAllRelatedExpensesQuery = {
  __typename?: 'Query'
  getAllRelatedExpenses: Array<{
    __typename?: 'Expense'
    id: string
    name: string
    timestamp: string
...
export type GetDebtSummaryQuery = {
  __typename?: 'Query'
  getDebtSummary: {
    __typename?: 'DebtSummary'
    totalAmount: number
...
export const FindPersonsDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'FindPersons' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'name' } },
...
} as unknown as DocumentNode<FindPersonsQuery, FindPersonsQueryVariables>
export const GetAllDebtsDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GetAllDebts' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
...
} as unknown as DocumentNode<GetAllDebtsQuery, GetAllDebtsQueryVariables>
...
export const GetAllRelatedExpensesDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
...
} as unknown as DocumentNode<GetAllRelatedExpensesQuery, GetAllRelatedExpensesQueryVariables>
export const GetDebtSummaryDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GetDebtSummary' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'topDebtors' },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
                      {
