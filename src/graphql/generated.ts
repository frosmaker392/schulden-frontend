...
export type MutationCreateOfflinePersonArgs = {
  name: Scalars['String'];
};
...
export type CreateOfflinePersonMutationVariables = Exact<{
  name: Scalars['String'];
}>;


export type CreateOfflinePersonMutation = { __typename?: 'Mutation', createOfflinePerson: { __typename?: 'OfflinePerson', id: string, name: string } };
...
export type GetAllRelatedExpensesQueryVariables = Exact<{
  personId: Scalars['String'];
}>;


export type GetAllRelatedExpensesQuery = { __typename?: 'Query', getAllRelatedExpenses: Array<{ __typename?: 'Expense', id: string, name: string, timestamp: string, totalAmount: number, payer: { __typename?: 'OfflinePerson', id: string } | { __typename?: 'User', id: string }, debtors: Array<{ __typename?: 'Debtor', amount: number, person: { __typename?: 'OfflinePerson', id: string } | { __typename?: 'User', id: string } }> }> };
...
export type GetPersonQuery = { __typename?: 'Query', getPerson: { __typename?: 'OfflinePerson', id: string, name: string } | { __typename?: 'User', email: string, id: string, name: string } };
...
export const CreateOfflinePersonDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"CreateOfflinePerson"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"name"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"createOfflinePerson"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"name"},"value":{"kind":"Variable","name":{"kind":"Name","value":"name"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}}]}}]} as unknown as DocumentNode<CreateOfflinePersonMutation, CreateOfflinePersonMutationVariables>;
...
export const GetAllRelatedExpensesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetAllRelatedExpenses"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"personId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"getAllRelatedExpenses"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"personId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"personId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"timestamp"}},{"kind":"Field","name":{"kind":"Name","value":"totalAmount"}},{"kind":"Field","name":{"kind":"Name","value":"payer"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}},{"kind":"Field","name":{"kind":"Name","value":"debtors"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"person"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}},{"kind":"Field","name":{"kind":"Name","value":"amount"}}]}}]}}]}}]} as unknown as DocumentNode<GetAllRelatedExpensesQuery, GetAllRelatedExpensesQueryVariables>;
